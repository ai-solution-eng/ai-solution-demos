...
FACT_CHECK_ENABLED = env_flag("FACT_CHECK_ENABLED", True)
FACT_CHECK_MODEL = os.getenv("FACT_CHECK_MODEL", "").strip() or DEFAULT_LLM_MODEL
FACT_CHECK_MAX_SOURCES = max(1, int(os.getenv("FACT_CHECK_MAX_SOURCES", "3")))
